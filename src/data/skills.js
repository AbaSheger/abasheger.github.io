...
export const skillCategories = [
  {
    ...
    icon: 'code',
    proficiency: 85,
    skills: ['Java', 'C#', '.NET', 'Python', 'Spring Boot', 'Spring Security', 'Spring Cloud', 'Spring Data JPA', 'Spring AOP', 'REST APIs', 'Postman', 'Keycloak', 'Maven', 'MySQL', 'PostgreSQL', 'H2', 'JUnit', 'Mockito', 'Vitest', 'TDD', 'Playwright', 'Ruby', 'JavaFX', 'Hibernate', 'Flyway', 'Kafka', 'Bucket4j', 'picocli', 'ASP.NET Core', 'EF Core', 'xUnit', 'WPF', 'MathNet.Numerics', 'Go', 'Kotlin', 'Groovy', 'Scala', 'Zod', 'Rust']
  },
  {
    id: 'devops',
    title: 'DevOps & CI/CD',
